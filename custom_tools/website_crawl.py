...
@tool
def extract_content(docs, tags_to_extract=["body"]):
    """
    A wrapper around an HTML content extraction tool. Useful for extracting specific content from documents based on HTML tags. Input should be documents and a list of tags to extract.
    """
